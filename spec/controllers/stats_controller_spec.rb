...
#    controller.stubs(:clear_session_user) ## Don't clear out the authenticated session
     ...
     @gf5.save
     @gf7 =  GenericFile.new(title:'Test Text', filename:'test1.txt', contributor:'Contrib2', read_groups:['public'], format_label:['OpenDocument Text'], creator:['testapp'])
     @gf7.apply_depositor_metadata(@user4.login)
     @gf7.save
