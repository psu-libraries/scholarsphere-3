...
describe Collection do
  describe "#bytes" do
    context "with no attached files" do
      subject { described_class.create(title: "My collection") { |c| c.apply_depositor_metadata("agw") }.bytes }
    ...
    context "with attached files" do
      ...
      let(:collection) do
        described_class.create(title: "My collection") { |c| c.apply_depositor_metadata("agw") }
      end
