...
FactoryGirl.define do
  ...
  factory :user_with_fixtures, class: User do |_u|
  ...
  factory :archivist, class: User do |_u|
    login 'archivist1'
    title "Archivist"
    ldap_available true
  end

  factory :curator, class: User do |_u|
    login 'curator1'
    title "Curator"
    ldap_available true
  ...
  factory :random_user, class: User do |_u|
  ...
  factory :test_user_1, class: User do |_u|
    login 'tstem31'
  end

  factory :test_user_2, class: User do |_u|
    login 'testapp'
  end
