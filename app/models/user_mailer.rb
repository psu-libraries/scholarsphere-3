class UserMailer < ActionMailer::Base
  ...
  def response_for_information(email, first_name)
    ...
    mail( to: email, bcc:ScholarSphere::Application.config.landing_email, from: ScholarSphere::Application.config.landing_from_email, subject: "Your inquiry about ScholarSphere")
  end
end
