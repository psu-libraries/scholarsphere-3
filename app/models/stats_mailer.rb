...
class StatsMailer < ActionMailer::Base
  def stats_mail(start_datetime, end_datetime)
    ...
    attachments[::I18n.t("statistic.report.csv.file_name", date_str: @presenter.date_str)] = GenericWorkListToCSVService.new(GenericWork.find_by_date_created(start_datetime, end_datetime)).csv
