...
class StatsMailer < ActionMailer::Base
  def stats_mail(start_datetime, end_datetime)
    ...
    attachments[::I18n.t("statistic.report.csv.file_name", date_str: @presenter.date_str)] = GenericWorkListToCSVService.new(Sufia::QueryService.new.build_date_query(start_datetime, end_datetime)).csv
