...
ActiveRecord::Schema.define(version: 20190117144338) do
  ...
  create_table "migrate_audits", id: :serial, force: :cascade do |t|
    t.string "f3_pid"
    t.string "f3_model"
    t.string "f3_title"
    t.string "f4_id"
  ...
  create_table "queued_files", id: :serial, force: :cascade do |t|
    t.string "work_id"
    t.string "file_id"
    t.string "filename"
    t.datetime "created_at", null: false
  ...
  create_table "sufia_features", id: :serial, force: :cascade do |t|
  ...
  create_table "superusers", id: :serial, force: :cascade do |t|
    t.integer "user_id", null: false
  end
