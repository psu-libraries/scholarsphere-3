...
ActiveRecord::Schema.define(version: 20160718110921) do
  ...
  create_table "subject_local_authority_entries", force: :cascade do |t|
    ...
    t.string   "uri",        limit: 255
    t.datetime "created_at",             default: '2016-07-18 11:08:31'
    t.datetime "updated_at",             default: '2016-07-18 11:08:31'
  end
